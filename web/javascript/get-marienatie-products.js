...
//     }) 
// }
async function getMarienatieProducts() {
    const getProducts = await fetch(`http://localhost:8080/api/products/products-by-brand?brand=marienatie`,{
        method: "GET",
        mode: 'cors',
        headers: {
